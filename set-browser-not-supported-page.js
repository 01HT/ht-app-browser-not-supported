...
document.body.innerHTML = `<style>
        ...
        <div id="container">
            <img id="logo" src="${window.appConfig.cloudinary.url}/image/upload/apps/common/browser-not-supported/browser-not-supported.svg" alt="Браузер не поддерживается">
